...
# Horiseon Website 
## Description
This is the first project for the coding bootcamp course. This project utilized starter code for the developer to clean up. The code included many <div> tags that were then replaced with various HTML semantic tags to give the code a better meaning that could then be further expanded upon by future developers. <alt> tags were also added to the images in the code to provide accessibility for screen reader users as well as if the images do not load on the webpage. The CSS file was then fixed as well. It was first placed in sequential order. Then some of the classes were condensed into the same line that provided the same function to condense the length of the code. This process was challenging as it required me to teach myself through research and by asking questions to my peers. But, by working through this project I learned what HTML semantics are, how to condense the CSS code, and what each part of the code was doing to the webpage. 
### Links
https://github.com/danielle-l-perry95/first-homework
danielle-l-perry95.github.io/first-homework
#### Screenshot Images
./assets/images/HoriseonScreenShot001.png
./assets/images/HoriseonScreenShot002.png
./assets/images/HoriseonScreenShot003.png
